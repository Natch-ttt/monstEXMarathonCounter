    ...
    const current = computed<Settings>(() => {
      if (!settingsById.value[currentId.value] && currentId.value != '') {
        ...
        settingsById.value[currentId.value] = {
          ...
          zetukyuEX: false,
          showZetuDrop3Count: true,
          showZetuDrop4Count: true,
          showZetuDrop5Count: true,
          showZetuDrop3CountRate: true,
          showZetuDrop4CountRate: true,
          showZetuDrop5CountRate: true,
