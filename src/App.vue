...
import { IonApp, IonMenu, IonHeader, IonToolbar, IonTitle,
         IonButtons, IonButton, IonContent,
         IonList, IonItem, IonLabel, IonRouterOutlet,
...
<style scoped>
/* モバイル（600px 未満）はデフォルトのまま */
@media (min-width: 600px) {
  /* menuId="recordMenu" を持つ ion-menu の幅を拡張 */
  ion-menu[menu-id="recordMenu"] {
    --width: 400px;   /* お好みの横幅に調整してください */
  }
}
